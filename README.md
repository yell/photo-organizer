...
![1](https://github.com/monstaHD/photo_organizer/blob/master/visualization%20demos/similar_1.png)
For a given photo, 15 the most closest images were shown, almost all of which are also about tennis. 
Remarkably, that the first (most relevant) 3 photos are actually taken from the very same match as the source image did.
